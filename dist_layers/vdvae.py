...
class VDVAE(nn.Module):
    def __init__(self, event_shape, rv_distribution):
        ...
        elif event_shape[2] == 128:
            h.dec_blocks = "1x2,4m1,4x3,8m4,8x7,16m8,16x15,32m16,32x31,64m32,64x4,128m64,128x2"
            h.enc_blocks = "128x2,128d2,64x4,64d2,32x20,32d2,16x9,16d2,8x8,8d2,4x7,4d4,1x5"
        else:
