...
class LBDistribution(nn.Module):
    def __init__(self):
        ...
        self.cnn = cnn.PixelCNNLayer([ 3, 32, 32 ], num_conditional=1500, output_distribution_layer=sp.SpatialIndependentDistributionLayer( [3, 32, 32] , dl.IndependentQuantizedLayer( num_buckets = 8), num_params=30 ) )
