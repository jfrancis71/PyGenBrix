...
def train_distribution(distribution, dataset, max_epoch, collate_fn=None, epoch_end_fn=None, batch_size=16):
    ...
    """
    dataloader = torch.utils.data.DataLoader(dataset, collate_fn=collate_fn, batch_size=batch_size, shuffle=True, drop_last=True)
